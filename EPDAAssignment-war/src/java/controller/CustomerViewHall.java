 ...
 * @author tweij
 */
@WebServlet(name = "CustomerViewHall", urlPatterns = {"/CustomerViewHall"})
public class CustomerViewHall extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.getRequestDispatcher("hallDetails.jsp").include(request, response);
