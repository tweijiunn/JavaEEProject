 ...
 * @author tweij
 */
@WebServlet(name = "RegisterSales", urlPatterns = {"/RegisterSales"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(!usernameExist){
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                request.getRequestDispatcher("register.jsp?action=1").include(request,response);
            }
        }
