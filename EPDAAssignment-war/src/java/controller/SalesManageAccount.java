 ...
 * @author tweij
 */
@WebServlet(name = "SalesManageAccount", urlPatterns = {"/SalesManageAccount"})
public class SalesManageAccount extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Users> users=usersFacade.findAll().stream().filter(user -> user.getInChargeBy()!=null?user.getInChargeBy().equals(salesPerson.getId()):false ).collect(Collectors.toList());
        ...
        if(!keyword.equalsIgnoreCase("all")) {
            ...
            users=usersFacade.findAll().stream()
                    .filter(user -> (user.getInChargeBy()!=null?user.getInChargeBy().equals(salesPerson.getId()):false) &&
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.getRequestDispatcher("sales_Manage_Account.jsp").include(request, response);
